package com.example.scannerai.presentation.orientating
...
import com.example.scannerai.databinding.FragmentOrientationBinding
import com.example.scannerai.presentation.preview.MainShareModel
import com.example.scannerai.presentation.scanner.ScannerFragment
...
class OrientationFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        Log.d("OrientationFragment", "onCreateView")
                    ...
                    frame?.let {
                        if (frame.session.allPlanes.any { it.type == Plane.Type.VERTICAL }) {
                            if (!navigating) {
                                navigating = true
                                val action =
                                    com.example.scannerai.presentation.orientating.OrientationFragmentDirections.actionOrientationFragmentToScannerFragment(
